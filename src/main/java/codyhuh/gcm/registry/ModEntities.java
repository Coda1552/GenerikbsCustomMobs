...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<Booger>> BOOGER = ENTITIES.register("booger", () -> EntityType.Builder.of(Booger::new, MobCategory.MONSTER).sized(3.0F, 3.0F).build(new ResourceLocation(GenerikbsCustomMobs.MOD_ID, "booger").toString()));
